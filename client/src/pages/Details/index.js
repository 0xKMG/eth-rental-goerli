  ...
  return (
    <Container fluid className="mt-5 d-flex flex-column justify-content-center align-items-center">
      ...
      <Text style={{ maxWidth: '50%', margin: '10px', textAlign: 'center' }}>
        Off chain listing details: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis eu est diam.
        Suspendisse non pellentesque nulla. Pellentesque facilisis fermentum erat eu interdum. rhoncus, sodales massa
        sit amet, congue mi. Praesent feugiat gravida erat, sit amet auctor tortor mattis non.
      </Text>
      {status === LOADING ||
        (status === WAITING && (
          <>
      ...
      {status === SOLD && !!txHash && (
        <>
          ...
          <Text>
            ...
            <Link to={{ pathname: `https://goerli.etherscan.io/tx/${txHash}` }} target="_blank">
              Etherscan
            </Link>
          </Text>
        </>
